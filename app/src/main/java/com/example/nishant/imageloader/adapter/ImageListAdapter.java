...
public class ImageListAdapter extends BaseAdapter {
    ...
    String[] list = new String[]{"http://www.planwallpaper.com/static/images/HD-Wallpapers1_FOSmVKg.jpeg",
            "http://www.intrawallpaper.com/static/images/jaguar_mexico-3840x2160.jpg",
            ...
            "https://www.hdwallpapers.net/previews/california-road-1016.jpg",
            "http://www.planwallpaper.com/static/images/Fall-wallpaper-1366x768-HD-wallpaper.jpg",
            "http://www.intrawallpaper.com/static/images/wall_X24JUmm.jpg",
            "http://www.planwallpaper.com/static/images/wallpapers-hd-8000-8331-hd-wallpapers.jpg",
            "http://www.intrawallpaper.com/static/images/HD-Wallpaper-170.jpg",
            "https://newevolutiondesigns.com/images/freebies/cool-wallpaper-1.jpg",
            "http://www.intrawallpaper.com/static/images/HD-Wallpaper-Pictures-A71.jpg",
            "https://newevolutiondesigns.com/images/freebies/cool-wallpaper-5.jpg",
            "http://www.planwallpaper.com/static/images/beach-cool-wallpaper-hd_1.jpg",
            "http://www.pixelstalk.net/wp-content/uploads/2016/03/Hd-superman-free-wallpaper.jpg",
            "http://hdwallpaperbackgrounds.net/wp-content/uploads/2015/07/HD-Wallpapers-New-Image.jpg",
            "http://hdwallpaperbackgrounds.net/wp-content/uploads/2015/11/HD-Wallpaper-Moon.jpg",
            "http://www.newhdwallpapers.in/wp-content/uploads/2015/07/Amazing-Earth-Place-Yoga-HD-Wallpaper.jpg",
            "https://www.socialbuzzcom.com/wp-content/uploads/2016/09/hd-wallpaper-1.jpg",
            "http://www.intrawallpaper.com/static/images/Rolling_Waves_Mod-ultra-HD.jpg",
            "https://4.bp.blogspot.com/-dFZSF8ZESBM/VIBYiGDfltI/AAAAAAABYbM/bNuPZ0bUHko/s0/Constance%2BHalaveli%2BMaldives%2BUHD.jpg",
            "http://www.planwallpaper.com/static/images/a601cb579cc9a289bc51cd41d8bcf478_large.jpg",
            "http://www.pixelstalk.net/wp-content/uploads/2015/05/Sky-Blue-Sea-Unique-HD-Wallpaper.jpg",
            "http://www.hdbloggers.net/wp-content/uploads/2016/09/Amazing-Stone-Art-HD-Wallpapers.jpg",
            "http://plusquotes.com/images/quotes-img/Nithf7m.jpg",
            "https://static.pexels.com/photos/33045/lion-wild-africa-african.jpg",
            "http://picsoverflow.com/wp-content/uploads/2016/04/beautiful-city-HD-wallpaper.jpg",
            "http://www.intrawallpaper.com/static/images/Background-Wallpaper-HD-Wallpapers_vVNlOsG.jpg",
            "http://hdwallpaperbackgrounds.net/wp-content/uploads/2016/07/hd-wallpaper-1080p-12.jpg",
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            holder = new ViewHolder((ImageView) view.findViewById(R.id.imageView));
        } else {
            holder = (ViewHolder) view.getTag();
        }

        MVNetworkClient.getInstance().addImageRequest(holder.imageView, new ImageResponseListener(aList.get(position),holder));
    ...
    private static class ImageResponseListener extends ResponseListener<Bitmap> {

        private final WeakReference<ViewHolder> weakRef;

        public ImageResponseListener(String url, ViewHolder imageViewHolder) {
            super(Bitmap.class, url);
            weakRef = new WeakReference<>(imageViewHolder);
        }
